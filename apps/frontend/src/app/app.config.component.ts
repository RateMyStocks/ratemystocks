            ...
            <div class="layout-config-content">
                <div class="layout-config-form" id="config-form">
                    <div class="layout-config-header">
                        ...
                        <span
                            >Select different themes for layout, topbar, menu
                            etc.</span
                        >
                    </div>
                    ...
                    <div
                        id="lightdark-panel"
                        class="layout-config-section options"
                    >
                        <h6>Color Mode</h6>
                        <div class="p-d-flex p-jc-between">
                            <div class="p-d-flex p-ai-center">
                                ...
                                ></p-radioButton>
                                <label for="layoutMode1" class="p-ml-2"
                                    >Light</label
                                >
                            </div>
                            <div class="p-d-flex p-ai-center">
                                <p-radioButton
                                    ...
                                    (onClick)="onLayoutModeChange($event)"
                                ></p-radioButton>
                                <label for="layoutMode2" class="p-ml-2"
                                    >Dark</label
                                >
                            </div>
                            <div class="p-d-flex p-ai-center">
                                <p-radioButton
                                    ...
                                    (onClick)="onLayoutModeChange($event)"
                                ></p-radioButton>
                                <label for="layoutMode3" class="p-ml-2"
                                    >Dim</label
                                >
                            </div>
                        </div>
                        ...
                        <div class="p-d-flex p-jc-between">
                            <div class="p-d-flex p-ai-center">
                                <p-radioButton
                                    ...
                                    inputId="menuMode1"
                                ></p-radioButton>
                                <label for="menuMode1" class="p-ml-2"
                                    >Static</label
                                >
                            </div>
                            <div class="p-d-flex p-ai-center">
                                <p-radioButton
                                    ...
                                    inputId="menuMode2"
                                ></p-radioButton>
                                <label for="menuMode2" class="p-ml-2"
                                    >Overlay</label
                                >
                            </div>
                            <div class="p-d-flex p-ai-center">
                                <p-radioButton
                                    ...
                                    inputId="menuMode3"
                                ></p-radioButton>
                                <label for="menuMode3" class="p-ml-2"
                                    >Horizontal</label
                                >
                            </div>
                        </div>
                        ...
                        <div class="p-d-flex p-jc-between">
                            <div class="p-d-flex p-ai-center">
                                <p-radioButton
                                    ...
                                    inputId="menuTheme1"
                                ></p-radioButton>
                                <label for="menuTheme1" class="p-ml-2"
                                    >Light</label
                                >
                            </div>
                            <div class="p-d-flex p-ai-center">
                                <p-radioButton
                                    ...
                                    inputId="menuTheme2"
                                ></p-radioButton>
                                <label for="menuTheme2" class="p-ml-2"
                                    >Dark</label
                                >
                            </div>
                            <div class="p-d-flex p-ai-center">
                                <p-radioButton
                                    ...
                                    inputId="menuTheme3"
                                ></p-radioButton>
                                <label for="menuTheme3" class="p-ml-2"
                                    >Dim</label
                                >
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div class="p-d-flex p-jc-between">
                            <div class="p-d-flex p-ai-center">
                                ...
                                ></p-radioButton>
                                <label for="topbarTheme1" class="p-ml-2"
                                    >Light</label
                                >
                            </div>
                            <div class="p-d-flex p-ai-center">
                                ...
                                ></p-radioButton>
                                <label for="topbarTheme2" class="p-ml-2"
                                    >Dark</label
                                >
                            </div>
                            <div class="p-d-flex p-ai-center">
                                ...
                                ></p-radioButton>
                                <label for="topbarTheme3" class="p-ml-2"
                                    >Dim</label
                                >
                            </div>
                        </div>
