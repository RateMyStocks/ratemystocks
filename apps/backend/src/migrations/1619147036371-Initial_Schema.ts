...
export class InitialSchema1619147036371 implements MigrationInterface {
    name = 'InitialSchema1619147036371'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_account" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "username" character varying(100) NOT NULL, "email" citext NOT NULL, "password" character varying NOT NULL, "salt" character varying NOT NULL, CONSTRAINT "uq_user_account_email" UNIQUE ("email"), CONSTRAINT "uq_user_account_username" UNIQUE ("username"), CONSTRAINT "PK_6acfec7285fdf9f463462de3e9f" PRIMARY KEY ("id"))`);
